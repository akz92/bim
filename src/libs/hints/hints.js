var settings = { linkHintCharacters: ['t','n','s','e','r','i','a','o'] }
 ...
 * it can still be wrappig other visible children.
...
function isVisible(element, clientRect) {
  ...
  //
  //n Coordinates truncation occcurs when using zoom. In that case, clientRect coords should be float,
